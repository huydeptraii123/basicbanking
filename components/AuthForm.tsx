...
const AuthForm = ({ type }: {type: string}) => {
  ...
  return (
        ...
        <header className="flex flex-col gap-5 md:gap-8">
            <Link href="/" className="cursor-pointer flex item-center gap-1">
                    <Image
                        ...
                        alt="Horizon logo"
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">SHBank</h1>
                </Link>
      ...
      {user ? (
        ...
        <>
            <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w">
            {type === 'sign-up' && (
                <>
            ...
            <CustomInput 
            control={form.control} name='email' label='Email' placeholder='huypro123@example.com'
            />
