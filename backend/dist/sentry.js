...
const tracesSampleRate = Number((_a = process.env.SENTRY_TRACES_SAMPLE_RATE) !== null && _a !== void 0 ? _a : 0.1);
const profilesSampleRate = Number((_b = process.env.SENTRY_PROFILES_SAMPLE_RATE) !== null && _b !== void 0 ? _b : 0);
